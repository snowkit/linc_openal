...
extern class AL {
    ...
    //buffer data and state
            ...
            @:native('snowkit_openal::bufferData')
...
// contexts
        ...
        @:native('snowkit_openal::createContext')
